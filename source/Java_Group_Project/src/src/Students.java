/*
   Igor Dmitriev
   5.11.2019
   Класс logic.Students, описывающий поля и методы для доступа к
   данным полям
 */
...
/*   Единственный метод интерфейса Comparable,
     Возвращающий целое число <0, если объект obj <,
     0 - если равни или отрицательное число если больше
 */
